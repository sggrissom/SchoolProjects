...
set CommonCompilerFlags= -DSLOW=1 -DDEBUG=1 -I w:\slib -nologo -Gm- -GR- -EHa- -Oi -WX -W4 -FC -Z7 -EHsc %IgnoredWarnings%
...
cl %CompilerFlags% ..\homework4\main.cpp /link %CommonLinkerFlags%
